...
import learning_falcon.app
import learning_falcon.images
...
def client(mock_store):
    api = learning_falcon.app.create_app(mock_store)
...
def test_post_image(client, mock_store):
    ...
    # saver_call is a mock.call tuple. It's first element is a tuple of positional arguments supplied when calling
    # the mock.
...
def test_saving_image(monkeypatch):
    ...
    store = learning_falcon.images.ImageStore(
        storage_path,
